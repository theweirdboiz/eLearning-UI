          ...
          <nav>
            <ul className="flex items-center text-[1.8rem]">
              ...
              <li className="ml-[2.5rem] group/menu-child">
                ...
                after:cursor-pointer after:h-[4.25rem] after:left-0 after:top-0 after:w-full after:-translate-y-full before:absolute before:content-[''] before:top-0 before:left-[3rem] before:w-[5rem] before:h-[5rem] before:rotate-45 before:-translate-y-[20%] before:bg-backGround before:-z-30 before:rounded-lg"
                >
                  <Link
                    to="/categories"
