        ...
        <div className="flex items-center justify-between">
          ...
          <div className="">
            <div className="flex justify-between items-center rounded-2xl">
              <input
                ref={inputSearchRef}
                className="lg:min-w-[32rem] w-full py-[1rem] pl-6 pr-16 rounded-l-full bg-lightBlue placeholder-primary placeholder:text-[#222] placeholder:font-medium"
                type="text"
              ...
              {!isSearch ? (
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="icon__search bg-lightBlue rounded-r-3xl"
