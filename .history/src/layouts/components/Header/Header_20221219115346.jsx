...
const Header = () => {
  ...
  const normalLink = "flex items-baseline gap-x-3 header__text";
  const activeLink = "flex items-baseline gap-x-3 header__text text-primary";
  return (
            ...
            <nav>
              <ul className="hidden lg:flex lg:items-center text-[1.8rem]">
                ...
                <li className="ml-[2rem] group/menu-child">
                  <NavLink
                    to="/categories"
                    className="flex items-baseline gap-x-3 header__text whitespace-nowrap"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="#0056d2"
