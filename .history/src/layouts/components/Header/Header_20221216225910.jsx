          ...
          <nav>
            <ul className="flex items-center text-[1.8rem]">
              ...
              <li className="ml-[2.5rem] group/menu-child">
                ...
                <div
                  className="shadow-shadowSmall border border-lightBlue group-hover/menu-child:flex hidden items-center mt-[4rem] p-[2.5rem] absolute z-20 font-medium bg-backGround rounded-2xl whitespace-nowrap after:absolute after:content-[''] 
