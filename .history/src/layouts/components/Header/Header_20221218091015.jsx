      ...
      <div className="lg:container">
        <div className="flex items-center">
          ...
          <div className="ml-auto">
            <div className="absolute md:left-0 md:bottom-0 md:w-full flex justify-between items-center rounded-2xl">
              <input
                ref={inputSearchRef}
                className="lg:min-w-[32rem] w-full md:translate-y-full py-[1rem] pl-6 pr-16 rounded-full bg-lightBlue placeholder-primary placeholder:text-[#222] placeholder:font-medium"
                type="text"
              ...
              {!isSearch ? (
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-8 h-8 absolute right-6 cursor-pointer top-0"
          ...
          <Link to="/cart" className="relative ml-[2.5rem]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
