      ...
      <div className="container">
        <div className="flex items-center justify-between gap-x-24">
          ...
          <div className="flex items-center w-[50%] gap-x-10  justify-between">
            <Link
              to="/active"
              className="flex items-baseline gap-x-3 border border-b-primary px-4 py-4 rounded-full text-[14px] font-semibold"
            >
            ...
            <Link to="/help" className="text-[14px] font-semibold">
              Hỗ trợ
            </Link>
            <Link
              to="/sign-in"
