          ...
          <nav>
            <ul className="flex items-center text-[1.8rem]">
              ...
              <li className="ml-[2.5rem] group/menu-child">
                ...
                <div
                  className="shadow-shadowSmall border border-lightBlue group-hover/menu-child:flex hidden items-center mt-[4rem] p-[2.5rem] absolute z-30 font-medium bg-backGround rounded-2xl whitespace-nowrap after:absolute after:content-[''] 
                after:cursor-pointer after:h-[4.25rem] after:left-0 after:top-0 after:w-full after:-translate-y-full before:absolute before:content-[''] before:top-0 before:left-[3rem] before:w-[5rem] before:h-[5rem] before:rotate-45 before:-translate-y-[20%] before:bg-backGround before:-z-10 before:rounded-lg"
                >
                  <Link
                    to="/categories"
