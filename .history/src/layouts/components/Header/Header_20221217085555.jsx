      ...
      <div className="container">
        <div className="flex items-center">
          ...
          <div className="relative ml-auto">
            ...
            <div className="mt-[5rem] px-[3rem] py-[2rem] rounded-xl absolute left-0 shadow-shadowSmall bg-backGround before:absolute before:content-[''] before:w-[5rem] before:h-[5rem] before:bg-backGround before:rotate-45 before:right-4 before:translate-y-[-50%]">
