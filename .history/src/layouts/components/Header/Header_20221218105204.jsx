...
const Header = () => {
  ...
  return (
    <div className="py-[1.2rem] relative z-50">
      ...
      <div className="fixed right-0 w-[30rem] bg-backGround">
        <div className="flex items-center gap-x-3 p-[3rem]">
          <img src="" alt="" className="rounded-full" />
          <h3>Hello, trandoankienthuc</h3>
        </div>
        <ul className="mt-3 overflow-y-auto">
          <li className="">
            <Link to="" className="p-[2rem]">
              Kích hoạt mã
            </Link>
          </li>
          <li className="">
          ...
          <li>
            <button className="block font-semibold w-full mx-auto mt-5 py-[1rem] rounded-md text-white bg-primary">
              Đăng nhập
            </button>
          </li>
        </ul>
