      ...
      <div className="container">
        <div className="flex items-center">
          ...
          <div className="relative ml-auto flex justify-between items-center round">
            <input
              className="min-w-[32rem] py-[1rem] pl-6 pr-16 rounded-full bg-lightBlue placeholder-primary placeholder:font-semibold"
              type="text"
          ...
          <nav>
            <ul className="flex items-center text-[1.8rem]">
              ...
              <Link
                to="/categories"
                className="flex items-center gap-x-3 px-4 py-4  rounded text-[1.8rem] font-medium ml-[2.5rem]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#0056d2"
