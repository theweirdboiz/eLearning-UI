    ...
    <div className="py-[1.2rem] bg-white shadow-sm">
      <div className="container">
        <div className="flex items-center">
          ...
          <div className="relative ml-auto flex justify-between items-center">
            <input
              className="min-w-[32rem] h-[38px] py-[1rem] px-6 rounded-full border-2 border-backGround focus:border-primary shadow text-[14px] font-semibold"
              type="text"
