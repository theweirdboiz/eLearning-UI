          ...
          <nav>
            <ul className="flex items-center text-[1.8rem]">
              ...
              <li className="ml-[2.5rem]">
                ...
                <div className="flex items-center mt-[4rem] p-[2.5rem] absolute z-20 bg-backGround rounded-2xl whitespace-nowrap">
                  <Link
                    to="/categories"
                  ...
                  <Link
                    to="/coming"
                    className="mx-[2.5rem] px-[2.5rem] flex items-center  border-l border-l-primary"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                  ...
                  <Link className="mx-[2.5rem] px-[2.5rem] flex items-center  border-l border-l-primary">
