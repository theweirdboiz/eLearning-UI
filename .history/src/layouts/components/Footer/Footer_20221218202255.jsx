      ...
      <div className="grid grid-cols-2 gap-x-1">
        ...
        <div className="my-[1.5rem]">
          ...
          <div className="flex items-baseline gap-x-4">
            <a className="mt-[1rem] p-3 rounded-full bg-white w-[3rem] h-[3rem] flex items-center justify-center shadow-md cursor-pointer">
              <FontAwesomeIcon icon={faFacebookF} />
            </a>
            <a className="mt-[20px] p-3 rounded-full bg-white w-[3rem] h-[3rem] flex items-center justify-center shadow-md cursor-pointer">
          ...
          <a href="" className="mt-[1rem] inline-block">
            <img src="https://kt.city/static/bct.png" alt="" />
          </a>
        </div>
      </div>
      <p className="text-center text-[14px] max-w-[60rem] mt-[2rem] mx-auto">
