...
const Footer = () => {
  return (
    <section className="container pt-[2.5rem] md:pt-[40px] bg-register-expert bg-top bg-cover text-lightBlack">
      <div className="grid grid-cols-2 md:flex md:items-start md:justify-between gap-x-1 md:max-w-[128rem]">
        <div className="my-[1.5rem] col-span-full w-[calc(100%_-_ 3.5rem)]">
        ...
        <div className="my-[1.5rem] col-span-full md:w-[calc(100%_-_ 3.5rem)]">
          <h3 className="font-semibold mb-[1rem]">Địa chỉ</h3>
          <p className="mt-[1rem]">
            202 Hoàng Văn Thụ, Phường 9, Quận Phú Nhuận, TP HCM
          </p>
        </div>
        <div className="my-[1.5rem] md:w-[calc(100%_-_ 3.5rem)]">
        ...
        <div className="my-[1.5rem] md:w-[calc(100%_-_3.5rem)]">
