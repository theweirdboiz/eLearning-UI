    ...
    <div className="pt-[40px]">
      <div className="container grid grid-cols-5">
        ...
        <div className="">
          ...
          <span className="mt-[20px]">fb</span>
          <span className="mt-[20px]">youtube</span>
          <span className="mt-[20px]">tiktok</span>
          <span className="mt-[20px]">twitter</span>
          <span className="mt-[20px]">ins</span>
        </div>
      </div>
      <p>
