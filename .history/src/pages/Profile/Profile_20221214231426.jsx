      ...
      <div className="p-16 shadow-lg  gap-x-4 rounded-2xl mt-10">
        <div className="flex items-center mb-20">
          ...
          <form action="" className="w-full">
            <div className="border-[1px] border-lightBlue mb-410p-4 rounded-2xl relative">
              <input
                type="text"
            ...
            <div className="bg-lightBlue border-[1px] border-lightBlue mb-10 p-4 rounded-2xl relative">
              <input
                type="text"
                placeholder="User name"
                className="w-full "
