    ...
    <div className="container">
      <div className="flex gap-x-10 p-20">
        <div className="shadow-xl">
          ...
          <h2 className="px-8 py-4 cursor-pointer">Khu vực học tập</h2>
          <h2 className="px-8 py-4 cursor-pointer">Kích hoạt mã</h2>
          <h2 className="px-8 py-4 cursor-pointer">Nhận hỗ trợ</h2>
        </div>
