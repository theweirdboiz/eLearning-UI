...
const MyClass = () => {
  ...
  return (
    <div className="container relative shadow-2xl">
      <h1 className="text-[2.4rem] font-bold mb-3 text-primary">
        Khu vực học tập
      </h1>
      <p className="mb-16">
      ...
      <ul className="flex items-center gap-x-4">
        <li
          ...
          className={`${
            actived === 1 && "border-b border-b-primary text-primary"
        ...
        <li
          ...
          className={`${
            actived === 2 && "border-b border-b-primary text-primary"
          } cursor-pointer px-12 py-4 font-semibold `}
        >
          <h4>Trend 24h qua?</h4>
        </li>
        <li
          ...
          className={`${
            actived === 3 && "border-b border-b-primary text-primary"
          } cursor-pointer px-12 py-4 font-semibold `}
        >
          <h4>Review mới</h4>
        </li>
      ...
      {actived === 1 && (
        <>
          <Link
            to="/lesson"
            className="shadow-2xl flex items-center my-10 rounded-3xl cursor-pointer"
          >
            <img
