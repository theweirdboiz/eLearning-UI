      ...
      <div className="grid grid-cols-2 gap-[150px]">
        <div className="mt-[30px]">
          ...
          <form action="">
            ...
            <div className="mt-5 border border-lightBlue py-3 px-1 ">
              <select className="border w-full cursor-pointer">
                <option defaultValue>Sự cố đơn hàng</option>
                <option>Sự cố đơn hàng</option>
                <option>Sự cố đơn hàng</option>
                <option>Sự cố đơn hàng</option>
              </select>
            </div>
            ...
            <div className="mt-[20px]">
              ...
              <div className="grid grid-cols-3 my-[10px] gap-x-4 place-items-center">
                <label className="flex items-center w-[14rem] h-[14rem] justify-center cursor-pointer border-[1px] border-lightBlue">
