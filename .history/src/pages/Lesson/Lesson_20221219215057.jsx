...
const Lesson = () => {
  return (
    <div className="ml-auto w-[calc(100%-42rem)]">
      ...
      <div className="py-[4.5rem] px-[10rem] bg-avatar-menu bg-no-repeat bg-cover bg-top bg-lesson">
        ...
        <div className="p-[3.5rem] border border-bgLightGreen shadow-shadowSmall">
          ...
          <div className="inline-block">
            <Link className="flex gap-x-2 items-center text-white text-[1.8rem] font-semibold bg-primary px-6 py-5 rounded-2xl">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
