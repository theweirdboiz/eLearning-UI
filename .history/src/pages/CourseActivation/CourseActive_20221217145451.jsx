...
const CourseActive = () => {
  return (
    <div className="max-w-[52.5rem] text-center py-[4.5rem] px-[2rem] mx-auto">
      ...
      <div className="fixed overflow-hidden inset-0 z-50 flex items-center justify-center opacity-100 visible bg-fadeBlack">
        <div className="max-w-[100rem] mx-auto m-h-[90vh] h-auto bg-backGround shadow-xl rounded-2xl relative">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-10 h-10 absolute right-4 top-2"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
