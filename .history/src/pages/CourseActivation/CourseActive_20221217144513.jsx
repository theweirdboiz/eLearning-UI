  ...
  return (
    <div className="max-w-[52.5rem] text-center py-[4.5rem] px-[2rem] mx-auto">
      ...
      <img
        ...
        alt=""
      />
      <div className="mb-[2.5rem] grid grid-cols-auto gap-x-5">
        <input
          type="text"
      ...
      <div className="fixed overflow-hidden inset-0 z-50 flex items-center justify-center opacity-100 visible ">
        <div className="w-full m-w-[100rem] mx-auto m-h-[90vh] h-auto bg-backGround shadow-xl rounded-2xl relative">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <div className="p-[5rem] grid grid-cols-2 gap-x-[5rem]">
            <div className="">
              <img src="" alt="" />
              <h3>Video hướng dẫn kích hoạt COD</h3>
              <p>
