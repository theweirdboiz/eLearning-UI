...
const CourseActive = () => {
  return (
    <div className="text-center py-[4.5rem] px-[2rem] mx-auto">
      ...
      <img
        ...
        alt=""
      />
      <div className="mb-[2.5rem] grid-cols-2 gap-x-5">
        <input
          type="text"
          placeholder="Mã COD/E-voucher"
          className="py-[1.5rem] px-[2rem] bg-lightGreen rounded-3xl"
        />
        <button className="w-[15rem] p-[1.5rem] rounded-lg bg-primary text-white">
          Kích hoạt
        </button>
      </div>
    </div>
