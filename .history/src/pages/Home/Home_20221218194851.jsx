    ...
    <div className="">
      ...
      <div className="container__page">
        <div className="my-[6rem]">
          ...
          <div className="grid auto-cols-33rem grid-flow-col snap-mandatory snap-always overflow-x-auto overflow-y-hidden touch-manipulation scroll-p-[1rem] lg:grid-cols-3 gap-x-[3rem]">
            <Course></Course>
            <Course></Course>
