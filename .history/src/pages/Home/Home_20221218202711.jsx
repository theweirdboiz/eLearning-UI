    ...
    <div className="">
      ...
      <div className="container__page">
        ...
        <div className="py-[3rem]">
          <div className="grid md:grid-cols-auto lg:grid-cols-2 gap-x-[3rem] mb-[5rem] md:mb-[10rem]">
            <img
          ...
          <div className="grid md:grid-cols-auto lg:grid-cols-2 gap-x-[3rem] mb-[5rem] items-center md:mb-[10rem]">
            ...
            <img
              className="max-w-[450px] mx-auto mb-[1rem] order-1"
