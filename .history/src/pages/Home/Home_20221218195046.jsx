    ...
    <div className="">
      ...
      <div className="container__page">
        <div className="my-[6rem]">
          ...
          <div className="grid auto-cols-33rem grid-flow-col snap-x snap-mandatory snap-always overflow-x-auto overflow-y-hidden touch-manipulation scroll-p-[1rem] lg:grid-cols-3 gap-x-[3rem]">
            <Course></Course>
            <Course></Course>
        ...
        <div className="my-[6rem]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-[3rem]">
            <Course src="https://kt.city/_next/image?url=%2Fstatic%2Flabel-new.png&w=128&q=75"></Course>
            <Course></Course>
            <Course></Course>
          </div>
