    ...
    <div className="">
      ...
      <div className="container__page">
        ...
        <div className="pt-[10rem]">
          <div className="grid md:grid-cols-2 lg:grid-cols-3gap-x-[3rem] items-center px-[2rem] mb-[10rem]">
            <img
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-[3rem] items-center mb-[10rem]">
            <div className="">
              <h1 className="mb-6 text-[2.8rem] font-extrabold">
