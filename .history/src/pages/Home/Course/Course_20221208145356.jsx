...
const Course = () => {
  return (
    <div className="bg-lightBlue rounded-xl relative shadow-2xl group/course">
      ...
      <div className="w-[340px] absolute top-0 translate-y-[-20%] translate-x-[85%] group-hover/course:visible invisible shadow-md p-10 border border-b-primary bg-white z-20">
        <h1 className="font-semibold text-[16px] min-h-[40px]">
