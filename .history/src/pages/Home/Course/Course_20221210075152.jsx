...
const Course = ({ isLast }) => {
  ...
  return (
    <div className="p-[20px]">
      <div className="rounded-xl relative shadow-2xl group/coursecursor-pointer">
        <a href="overflow-hidden bg-lightBlue">
          <span className="absolute bg-primary text-white px-2 rounded">
            72%
          </span>
          <div className="">
            <img
          ...
          <div className="px-6">
            <h2 className="font-semibold mt-[10px]">
              Học đệm đàn cùng Kikikta
            </h2>
        ...
        >
          ...
          <p className="mt-5 line-clamp-3 overflow-hidden text-[16px]">
            Khóa học chứng khoán nhập môn sẽ giúp bạn nắm bắt được kiến thức,
            đầu tư chứng khoán đầy đủ. Bài bản và chi tiết nhất dành cho người
