...
const Course = () => {
  return (
    <div className="bg-white rounded-xl relative shadow-md overflow-hidden group/course">
      <a href="">
      ...
      <div className="absolute right-[-40px] top-0 group-hover/course:visible invisible">
        <h1>AAAAAA</h1>
      </div>
    </div>
  );
