...
const Course = () => {
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden group/course relative">
      <a href="">
      ...
      <div className="absolute invisible group-hover/course:visible z-10 right-0">
        <h1>AAAAAA</h1>
      </div>
    </div>
  );
