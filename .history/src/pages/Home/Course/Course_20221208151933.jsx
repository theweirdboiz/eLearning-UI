...
const Course = () => {
  return (
    <div className="rounded-xl relative shadow-2xl group/course p-[20px] cursor-pointer">
      ...
      <div className="w-[340px] absolute top-0 translate-y-[-20%] translate-x-[75%] group-hover/course:visible invisible shadow-md p-10 rounded-lg border-2 border-primary bg-white z-20">
