...
const CourseDetail = () => {
  ...
  return (
    <>
      ...
      <div className="relative pb-[12rem] pt-[4rem] bg-hero bg-cover bg-no-repeat bg-center bg-detail">
        <div className="container__page">
          <div className="flex items-center justify-center gap-x-[1rem] max-w-[18rem] mb-[3rem]  text-white text-[2.8rem] font-semibold bg-primary py-3 rounded-xl ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
