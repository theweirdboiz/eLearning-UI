      ...
      <div className="mt-8 flex items-center justify-between mb-10 ">
        <div className="relative">
          ...
          <ul className="absolute border border-lightBlue w-full rounded-xl bg-backGround">
            <li className="py-3 px-6 hover:bg-lightBlue">Tất cả</li>
            <li className="py-3 px-6 hover:bg-lightBlue">Chờ duyệt</li>
            <li className="py-3 px-6 hover:bg-lightBlue">Chấp nhận</li>
            <li className="py-3 px-6 hover:bg-lightBlue">Từ chối</li>
          </ul>
        </div>
