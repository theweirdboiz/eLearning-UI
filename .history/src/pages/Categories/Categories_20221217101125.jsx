  ...
  return (
    <div className="py-[5rem]">
      <div className="container__page">
        ...
        <ul>
          <li className="flex items-center mr-[2rem] mb-[2rem] text-[2rem]">
            <div className="flex items-center justify-center bg-primary text-white rounded-full w-[4rem] h-[4rem] mr-[1.5rem]">
              #
            </div>
            <span>Tất cả</span>
          </li>
