    ...
    <div className="container p-6">
      <div className="max-w-[865px] mx-auto my-[40px] ">
        ...
        <div className="shadow-xl py-6 px-[4rem] bg-white rounded-2xl">
          ...
          <div className="flex items-center justify-between shadow-xl p-6 rounded-xl cursor-pointer">
        ...
        <div className="shadow-xl mt-[2rem] py-6 px-[4rem] bg-backGround rounded-2xl">
          <div className="flex items-center justify-between ">
            <div className="">
              ...
              <div className="px-4 py-2 text-primary shadow-xl inline-block rounded-xl">
