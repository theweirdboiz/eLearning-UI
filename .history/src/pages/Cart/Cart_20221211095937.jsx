  ...
  return (
    <div className="container p-6">
      <div className="max-w-[865px] mx-auto my-[40px] ">
        ...
        <div className="shadow-xl mt-[2rem] py-6 px-[4rem] bg-backGround rounded-2xl">
          <div className="flex items-center justify-between ">
            <div className="">
              ...
              <div className="px-4 py-2 text-primary shadow-inner inline-block rounded-xl">
        ...
        <button className="w-full bg-primary text-center mt-10 p-6 rounded-xl text-white">
