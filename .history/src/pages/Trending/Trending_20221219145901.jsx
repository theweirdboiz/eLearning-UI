  ...
  return (
    <div>
      ...
      <div className="p-[2rem]">
        <div className="flex mb-[2rem] shadow-shadowSmall bg-backGround rounded-2xl">
          <a
            href=""
          ...
          <div className="flex items-center flex-1 px-[3.5rem] py-[2rem]">
            ...
            <div className="flex justify-center items-center text-[6rem] font-bold w-[4rem] h-[4rem] rounded-full bg-primary flex-shrink-0">
              1
            </div>
          </div>
        </div>
