      ...
      <div className="bg-coming  bg-center bg-cover bg-no-repeat h-[30rem] pb-[2rem] flex flex-col justify-end items-center text-center lg:h-[81rem]">
        <div className="px-[2rem] translate-y-0 text-white md:max-w-[62rem] md:-translate-y-[14rem]">
          <div className="uppercase flex gap-x-3 items-center justify-center mb-[0.5rem]">
            <p className="font-bold md:text-[4.4rem]">Ktcity 24h trending</p>
            <img
              src="https://kt.city/static/trending.svg"
              alt=""
              className="max-w-[2rem] scale-[2] relative -top-1 md:max-w-[3.5rem]"
            />
          </div>
          <h4 className="text-[1.4rem] py-2 bg-lightPurple rounded-xl px-[1rem]">
