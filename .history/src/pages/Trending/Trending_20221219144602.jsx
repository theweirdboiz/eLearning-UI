...
const Trending = () => {
  return (
    <div>
      <div className="bg-coming  bg-center bg-cover bg-no-repeat h-[30rem] pb-[2rem] flex flex-col justify-end items-center">
        <div className="px-[2rem] translate-y-0 text-white">
          <div className="uppercase flex items-center justify-center mb-[0.5rem]">
            <span> Ktcity 24h trending</span>
            <img src="https://kt.city/static/trending.svg" alt="" />
          </div>
          <h4 className="text-[2.2rem] font-semibold  text-center py-5 bg-lightPurple rounded-xl">
