  ...
  return (
    <>
      ...
      <div className="my-10 flex items-center gap-x-14">
        <div className="w-[28rem] h-[16rem] bg-primary rounded-3xl p-8 text-white font-semibold">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <div className="w-[28rem] h-[16rem] bg-yellow rounded-3xl p-8 text-white font-semibold">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
