...
const CourseDetail = () => {
  return (
    <div className="py-[4rem] bg-hero px-[8rem]">
      ...
      <div className="flex items-center justify-between w-[60%] text-[2.4rem] text-white mb-[3rem]">
      ...
      <div className="flex justify-between">
        <div className="flex flex-col w-[calc(50% _-_ 2rem)">
          <img
        ...
        <div className="p-4 bg-white rounded-2xl text-[2.4rem] px-6 py-8 w-[40%]">
          <div className="">
