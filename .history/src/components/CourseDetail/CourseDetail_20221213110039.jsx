...
const CourseDetail = () => {
  return (
    <div className="py-[4rem] px-[8rem]">
      <div className="bg-hero flex items-center justify-center gap-x-[1rem] max-w-[18rem] text-white tex-[2.8rem] font-semibold bg-primary py-3 rounded-xl mb-[2.5rem]">
        <svg
