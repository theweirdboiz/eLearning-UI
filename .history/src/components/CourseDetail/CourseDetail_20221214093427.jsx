...
const CourseDetail = () => {
  ...
  return (
    <div className="container">
      ...
      <Tabs>
        <TabList className="flex justify-between pt-8 text-[2rem] border-b-lightBlue border-b mb-20">
          <Tab>
            <li
              onClick={() => setActivedTab(!activedTab)}
              className="cursor-pointer font-semibold text-primary border-b-primary border-b"
            >
