        ...
        <div className="p-4 bg-white rounded-2xl text-[2.4rem] w-[40%] px-6 py-8">
          <div className="">
            ...
            <form action="">
              ...
              />
              <button className="bg-primary w-full p-2 rounded-2xl text-white font-semibold mb-5">
                Đăng ký học (online)
              </button>
              <h6 className="text-[1.8rem] text-center my-2">
                Hoàn tất đăng ký bằng
              </h6>
              <div className="text-[1.8rem] flex items-center justify-center gap-x-5">
                <div className="">
