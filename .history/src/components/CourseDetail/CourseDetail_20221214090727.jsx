  ...
  return (
    <div className="container">
      ...
      <ul className="flex justify-between pt-8 text-[2rem] border-b-lightBlue border-b">
        <li className="cursor-pointer font-semibold text-primary border-b-primary border-b">
      ...
      {/* Comment */}
      <>
        <div className="p-4 pb-8 border-b border-b-lightBlue">
          <div className="">
            <img src="https://kt.city/static/avatar/avatar2.jpg" alt="" />
            <h3>Vũ</h3>
            <span>Gần đây</span>
          </div>
          <p>Rất ô sờ kê</p>
