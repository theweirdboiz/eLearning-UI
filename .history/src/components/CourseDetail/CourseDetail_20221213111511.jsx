...
const CourseDetail = () => {
  return (
    <div className="pb-[12rem] pt-[6rem] bg-hero px-[8rem] container bg-cover bg-no-repeat bg-center">
      ...
      <div className="flex justify-between">
        <div className="flex flex-col w-[calc(60%_-_2rem)] rounded-t-xl overflow-hidden">
          <img
