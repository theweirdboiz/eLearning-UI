...
const CourseDetail = () => {
  return (
    <div className="py-[4rem] bg-hero px-[8rem] mx-[4rem]">
      <div className="flex items-center justify-center gap-x-[1rem] max-w-[18rem] mx-[6rem] text-white tex-[2.8rem] font-semibold bg-primary py-3 rounded-xl mb-[2.5rem]">
        <svg
          ...
          <div className="">
            ...
            <form action="">
              ...
              <div className="text-[1.8rem] flex items-center justify-between gap-x-5">
                <div className="bg-lightBlue rounded-xl px-12 py-4">
