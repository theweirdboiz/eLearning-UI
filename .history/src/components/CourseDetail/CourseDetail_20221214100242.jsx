    ...
    <div className="container">
      ...
      <ul className="flex justify-between pt-8 text-[2rem] border-b-lightBlue border-b">
        <li
          ...
          className={`${
            activedTab === 1 ? "text-primary border-b-primary border-b" : ""
          } cursor-pointer`}
        >
        ...
        <li
          ...
          className={`${
            activedTab === 2 ? "text-primary border-b-primary border-b" : ""
          } cursor-pointer`}
        >
        ...
        <li
          ...
          className={`${
            activedTab === 3 ? "text-primary border-b-primary border-b" : ""
          } cursor-pointer`}
        >
        ...
        <li
          ...
          className={`${
            activedTab === 4 ? "text-primary border-b-primary border-b" : ""
          } cursor-pointer`}
        >
        ...
        <li
          ...
          className={`${
            activedTab === 5 ? "text-primary border-b-primary border-b" : ""
          } cursor-pointer`}
        >
        ...
        <ul className="flex flex-wrap justify-between items-start text-[1.8 rem]">
          <li className="w-[calc(50%-2rem)]">
            <div className="flex gap-x-3">
              ...
              <p>
                Nắm vững chắc các kiến thức cơ bản về HTML, các thẻ trong HTML –
                HTML5, cách đặt tên theo chuẩn BEM, học cách sử dụng Class Id và
                các attributes khác của HTML một cách chỉn chu từ đầu
              </p>
            </div>
          </li>
          <li className="w-[calc(50%-2rem)]">
