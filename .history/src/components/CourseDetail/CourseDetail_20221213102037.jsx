...
const CourseDetail = () => {
  return (
    <div className="py-[4rem] bg-hero container">
      <div className="flex items-center justify-center gap-x-[1rem] max-w-[18rem] text-white tex-[2.4rem] font-semibold bg-primary py-2 rounded-xl mb-[2.5rem]">
        <svg
